...
$(function() {		   
	// main menu toggler
	$('.nav .container').prepend('<div class="menu-icon"><a class="navbar-brand" href="${baseHome}"><img src="https://cdn.jsdelivr.net/gh/duchuy2023/public@main/logom.png" alt="Hoang Dien Logo" height="40"></a><span>Menu</span></div>');
